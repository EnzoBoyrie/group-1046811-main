...
export default function GetPurchaseAdmin() {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await fetch("http://localhost:3001/api/admin/purchase_history", {
        method: "GET",
        headers: {
  ...
  return (
    <div>
      ...
      <h1>Pokeshop Voir les achat des user effectuer ADMIN</h1>
      <div>
        ...
        <button onClick={fetchData}>Voir TOUS les achats</button>
      </div>
    </div>
  );
}
